...
Patricia's skills include C#, ASP.NET MVC, ASP, VB, Java, SQL Server, Sybase, Oracle, HTML5, JavaScript, JQuery, HTML, CSS, WebService, Integration Services and a solid understanding of databases such as SQL Server and Sybase; developing Queries, Procedures, Functions, Tables, Views and Triggers.  
